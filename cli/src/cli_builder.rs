...
fn xxx<'a>(command: CliCommand) -> Option<&'a str> {
    match command {
        ...
        CliCommand::ExternalSubnetAttach => Some("external-subnet attach"),
        CliCommand::ExternalSubnetDetach => Some("external-subnet detach"),
        CliCommand::ExternalSubnetList => Some("external-subnet list"),
        CliCommand::ExternalSubnetView => Some("external-subnet view"),
        CliCommand::ExternalSubnetUpdate => Some("external-subnet update"),
        CliCommand::ExternalSubnetCreate => Some("external-subnet create"),
        CliCommand::ExternalSubnetDelete => Some("external-subnet delete"),
