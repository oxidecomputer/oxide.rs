...
fn xxx<'a>(command: CliCommand) -> Option<&'a str> {
    match command {
        ...
        CliCommand::InternetGatewayIpPoolCreate => Some("internet-gateway ip-pool create"),
        CliCommand::InternetGatewayIpPoolDelete => Some("internet-gateway ip-pool delete"),
