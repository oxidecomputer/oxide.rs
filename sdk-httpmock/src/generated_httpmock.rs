...
pub mod operations {
    ...
    pub struct AlertListWhen(::httpmock::When);
    impl AlertListWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(
                inner
                    .method(::httpmock::Method::GET)
                    .path_matches(regex::Regex::new("^/v1/alerts$").unwrap()),
            )
        }
        ...
        pub fn alert_class<'a, T>(self, value: T) -> Self
        where
            T: Into<Option<&'a types::AlertSubscription>>,
        {
            if let Some(value) = value.into() {
                Self(self.0.query_param("alert_class", value.to_string()))
            } else {
                Self(self.0.query_param_missing("alert_class"))
            }
        }
    ...
    pub struct AlertListThen(::httpmock::Then);
    impl AlertListThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
        ...
        pub fn ok(self, value: &types::AlertResultsPage) -> Self {
            Self(
                self.0
                    .status(200u16)
                    .header("content-type", "application/json")
    ...
    pub struct AlertViewWhen(::httpmock::When);
    impl AlertViewWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(
                inner
        ...
        pub fn alert_id(self, value: &::uuid::Uuid) -> Self {
            let re = regex::Regex::new(&format!("^/v1/alerts/{}$", value.to_string())).unwrap();
            Self(self.0.path_matches(re))
        }
    }

    pub struct AlertViewThen(::httpmock::Then);
    impl AlertViewThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
        ...
        pub fn ok(self, value: &types::Alert) -> Self {
            Self(
                self.0
                    .status(200u16)
                    .header("content-type", "application/json")
    ...
    pub struct InstanceMulticastGroupListWhen(::httpmock::When);
    impl InstanceMulticastGroupListWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(
                inner.method(::httpmock::Method::GET).path_matches(
                    regex::Regex::new("^/v1/instances/[^/]*/multicast-groups$").unwrap(),
                ),
            )
        }
    ...
    pub struct InstanceMulticastGroupListThen(::httpmock::Then);
    impl InstanceMulticastGroupListThen {
        ...
        pub fn ok(self, value: &types::MulticastGroupMemberResultsPage) -> Self {
            Self(
                self.0
                    .status(200u16)
                    .header("content-type", "application/json")
    ...
    pub struct InstanceMulticastGroupJoinWhen(::httpmock::When);
    impl InstanceMulticastGroupJoinWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
    ...
    pub struct InstanceMulticastGroupJoinThen(::httpmock::Then);
    impl InstanceMulticastGroupJoinThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
    ...
    pub struct InstanceMulticastGroupLeaveWhen(::httpmock::When);
    impl InstanceMulticastGroupLeaveWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(inner.method(::httpmock::Method::DELETE).path_matches(
                regex::Regex::new("^/v1/instances/[^/]*/multicast-groups/[^/]*$").unwrap(),
            ))
    ...
    pub struct InstanceMulticastGroupLeaveThen(::httpmock::Then);
    impl InstanceMulticastGroupLeaveThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
    ...
    impl IpPoolListWhen {
        ...
        pub fn pool_type<T>(self, value: T) -> Self
        where
            T: Into<Option<types::IpPoolType>>,
        {
            if let Some(value) = value.into() {
                Self(self.0.query_param("pool_type", value.to_string()))
            } else {
                Self(self.0.query_param_missing("pool_type"))
            }
        }
    ...
    pub struct MulticastGroupListWhen(::httpmock::When);
    ...
    pub struct MulticastGroupListThen(::httpmock::Then);
    impl MulticastGroupListThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
        ...
        pub fn ok(self, value: &types::MulticastGroupResultsPage) -> Self {
            Self(
                self.0
                    .status(200u16)
                    .header("content-type", "application/json")
    ...
    pub struct MulticastGroupViewThen(::httpmock::Then);
    impl MulticastGroupViewThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
    ...
    pub struct MulticastGroupMemberListThen(::httpmock::Then);
    impl MulticastGroupMemberListThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
    ...
    pub struct RackMembershipAbortWhen(::httpmock::When);
    impl RackMembershipAbortWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(inner.method(::httpmock::Method::POST).path_matches(
                regex::Regex::new("^/v1/system/hardware/racks/[^/]*/membership/abort$").unwrap(),
            ))
        }
    ...
    pub struct RackMembershipAbortThen(::httpmock::Then);
    impl RackMembershipAbortThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
    ...
    impl SystemIpPoolListWhen {
        ...
        pub fn assignment<T>(self, value: T) -> Self
        where
            T: Into<Option<types::IpPoolAssignment>>,
        {
            if let Some(value) = value.into() {
                Self(self.0.query_param("assignment", value.to_string()))
            } else {
                Self(self.0.query_param_missing("assignment"))
            }
        }
    ...
    pub struct SystemIpPoolAssignWhen(::httpmock::When);
    impl SystemIpPoolAssignWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(
                inner.method(::httpmock::Method::POST).path_matches(
                    regex::Regex::new("^/v1/system/ip-pools/[^/]*/assignment$").unwrap(),
                ),
            )
        }
        ...
        pub fn body(self, value: &types::IpPoolAssignParam) -> Self {
            Self(self.0.json_body_obj(value))
        }
    }

    pub struct SystemIpPoolAssignThen(::httpmock::Then);
    impl SystemIpPoolAssignThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
    ...
    pub struct NetworkingBgpConfigUpdateWhen(::httpmock::When);
    impl NetworkingBgpConfigUpdateWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(
                inner
                    .method(::httpmock::Method::PUT)
        ...
        pub fn body(self, value: &types::BgpConfigUpdate) -> Self {
            Self(self.0.json_body_obj(value))
        }
    }

    pub struct NetworkingBgpConfigUpdateThen(::httpmock::Then);
    impl NetworkingBgpConfigUpdateThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
        ...
        pub fn ok(self, value: &types::BgpConfig) -> Self {
            Self(
                self.0
                    .status(200u16)
                    .header("content-type", "application/json")
    ...
    impl NetworkingBgpExportedThen {
        ...
        pub fn ok(self, value: &::std::vec::Vec<types::BgpExported>) -> Self {
            Self(
                self.0
                    .status(200u16)
                    .header("content-type", "application/json")
    ...
    pub struct NetworkingBgpImportedWhen(::httpmock::When);
    impl NetworkingBgpImportedWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(
                inner.method(::httpmock::Method::GET).path_matches(
                    regex::Regex::new("^/v1/system/networking/bgp-imported$").unwrap(),
                ),
            )
        }
    ...
    pub struct NetworkingBgpImportedThen(::httpmock::Then);
    impl NetworkingBgpImportedThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
        ...
        pub fn ok(self, value: &::std::vec::Vec<types::BgpImported>) -> Self {
            Self(
                self.0
                    .status(200u16)
                    .header("content-type", "application/json")
    ...
    pub struct SystemNetworkingSettingsViewWhen(::httpmock::When);
    impl SystemNetworkingSettingsViewWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(
                inner
                    .method(::httpmock::Method::GET)
                    .path_matches(regex::Regex::new("^/v1/system/networking/settings$").unwrap()),
            )
        }
    ...
    pub struct SystemNetworkingSettingsViewThen(::httpmock::Then);
    impl SystemNetworkingSettingsViewThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
        ...
        pub fn ok(self, value: &types::SystemNetworkingSettings) -> Self {
            Self(
                self.0
                    .status(200u16)
                    .header("content-type", "application/json")
    ...
    pub struct SystemNetworkingSettingsUpdateWhen(::httpmock::When);
    impl SystemNetworkingSettingsUpdateWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(
                inner
                    .method(::httpmock::Method::PUT)
        ...
        pub fn body(self, value: &types::SystemNetworkingSettingsUpdate) -> Self {
            Self(self.0.json_body_obj(value))
        }
    }

    pub struct SystemNetworkingSettingsUpdateThen(::httpmock::Then);
    impl SystemNetworkingSettingsUpdateThen {
        pub fn new(inner: ::httpmock::Then) -> Self {
            Self(inner)
        }
    ...
    impl SupportBundleListWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(
                inner
                    .method(::httpmock::Method::GET)
                    .path_matches(regex::Regex::new("^/v1/system/support-bundles$").unwrap()),
            )
        }
    ...
    impl SupportBundleDownloadWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(inner.method(::httpmock::Method::GET).path_matches(
                regex::Regex::new("^/v1/system/support-bundles/[^/]*/download$").unwrap(),
            ))
        }
    ...
    impl SupportBundleHeadWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(inner.method(::httpmock::Method::HEAD).path_matches(
                regex::Regex::new("^/v1/system/support-bundles/[^/]*/download$").unwrap(),
            ))
        }
    ...
    impl SupportBundleIndexWhen {
        pub fn new(inner: ::httpmock::When) -> Self {
            Self(inner.method(::httpmock::Method::GET).path_matches(
                regex::Regex::new("^/v1/system/support-bundles/[^/]*/index$").unwrap(),
            ))
        }
...
pub trait MockServerExt {
    ...
    fn alert_list<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(operations::AlertListWhen, operations::AlertListThen);
    fn alert_view<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(operations::AlertViewWhen, operations::AlertViewThen);
    ...
    where
        F: FnOnce(
            operations::InstanceMulticastGroupListWhen,
            operations::InstanceMulticastGroupListThen,
        );
    fn instance_multicast_group_join<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(
            operations::InstanceMulticastGroupJoinWhen,
            operations::InstanceMulticastGroupJoinThen,
        );
    fn instance_multicast_group_leave<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(
            operations::InstanceMulticastGroupLeaveWhen,
            operations::InstanceMulticastGroupLeaveThen,
        );
    ...
    fn rack_membership_abort<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(operations::RackMembershipAbortWhen, operations::RackMembershipAbortThen);
    ...
    fn system_ip_pool_assign<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(operations::SystemIpPoolAssignWhen, operations::SystemIpPoolAssignThen);
    ...
    fn networking_bgp_config_update<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(
            operations::NetworkingBgpConfigUpdateWhen,
            operations::NetworkingBgpConfigUpdateThen,
        );
    ...
    fn networking_bgp_imported<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(operations::NetworkingBgpImportedWhen, operations::NetworkingBgpImportedThen);
    ...
    fn system_networking_settings_view<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(
            operations::SystemNetworkingSettingsViewWhen,
            operations::SystemNetworkingSettingsViewThen,
        );
    fn system_networking_settings_update<F>(&self, config_fn: F) -> ::httpmock::Mock<'_>
    where
        F: FnOnce(
            operations::SystemNetworkingSettingsUpdateWhen,
            operations::SystemNetworkingSettingsUpdateThen,
        );
...
impl MockServerExt for ::httpmock::MockServer {
        ...
        F: FnOnce(operations::AlertListWhen, operations::AlertListThen),
    {
        self.mock(|when, then| {
            config_fn(
                operations::AlertListWhen::new(when),
                operations::AlertListThen::new(then),
            )
        })
    }
        ...
        F: FnOnce(operations::AlertViewWhen, operations::AlertViewThen),
    {
        self.mock(|when, then| {
            config_fn(
                operations::AlertViewWhen::new(when),
                operations::AlertViewThen::new(then),
            )
        })
    }
        ...
        ),
    {
        self.mock(|when, then| {
            config_fn(
                operations::InstanceMulticastGroupListWhen::new(when),
                operations::InstanceMulticastGroupListThen::new(then),
            )
        })
    }
        ...
        ),
    {
        self.mock(|when, then| {
            config_fn(
                operations::InstanceMulticastGroupJoinWhen::new(when),
                operations::InstanceMulticastGroupJoinThen::new(then),
            )
        })
    }
        ...
        ),
    {
        self.mock(|when, then| {
            config_fn(
                operations::InstanceMulticastGroupLeaveWhen::new(when),
                operations::InstanceMulticastGroupLeaveThen::new(then),
            )
        })
    }
        ...
        F: FnOnce(operations::MulticastGroupListWhen, operations::MulticastGroupListThen),
    {
        self.mock(|when, then| {
            config_fn(
                operations::MulticastGroupListWhen::new(when),
                operations::MulticastGroupListThen::new(then),
            )
        })
    }
        ...
        F: FnOnce(operations::RackMembershipAbortWhen, operations::RackMembershipAbortThen),
    {
        self.mock(|when, then| {
            config_fn(
                operations::RackMembershipAbortWhen::new(when),
                operations::RackMembershipAbortThen::new(then),
            )
        })
    }
        ...
        F: FnOnce(operations::SystemIpPoolAssignWhen, operations::SystemIpPoolAssignThen),
    {
        self.mock(|when, then| {
            config_fn(
                operations::SystemIpPoolAssignWhen::new(when),
                operations::SystemIpPoolAssignThen::new(then),
            )
        })
    }
        ...
        ),
    {
        self.mock(|when, then| {
            config_fn(
                operations::NetworkingBgpConfigUpdateWhen::new(when),
                operations::NetworkingBgpConfigUpdateThen::new(then),
            )
        })
    }
        ...
        F: FnOnce(operations::NetworkingBgpImportedWhen, operations::NetworkingBgpImportedThen),
    {
        self.mock(|when, then| {
            config_fn(
                operations::NetworkingBgpImportedWhen::new(when),
                operations::NetworkingBgpImportedThen::new(then),
            )
        })
    }
        ...
        ),
    {
        self.mock(|when, then| {
            config_fn(
                operations::SystemNetworkingSettingsViewWhen::new(when),
                operations::SystemNetworkingSettingsViewThen::new(then),
            )
        })
    }
        ...
        ),
    {
        self.mock(|when, then| {
            config_fn(
                operations::SystemNetworkingSettingsUpdateWhen::new(when),
                operations::SystemNetworkingSettingsUpdateThen::new(then),
            )
        })
    }
